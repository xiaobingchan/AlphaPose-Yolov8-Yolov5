...
def get_detector(opt=None, cfg=dict()):
    ...
    elif opt.detector == 'yolov8n':
        from detector.yolov8n_api import YOLOV8NDetector as det
        from detector.yolov8n_cfg import cfg as default_cfg
    elif opt.detector == 'yolov8s':
        from detector.yolov8s_api import YOLOV8SDetector as det
        from detector.yolov8s_cfg import cfg as default_cfg
