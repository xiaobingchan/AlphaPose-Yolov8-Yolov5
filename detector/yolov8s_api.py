...
from yolov8s.models.experimental import attempt_load
from yolov8s.utils.general import check_img_size, non_max_suppression
from yolov8s.utils.general import bbox_iou
from yolov8s.utils.preprocess import prep_image, prep_frame
from yolov8s.utils.util import unique
...
class YOLOV8SDetector(BaseDetector):
    def __init__(self, cfg, opt=None):
        super(YOLOV8SDetector, self).__init__()
